...
// dumping ground for completed



// quick check of Event2
...
TCanvas c4("c4","multipads",1000,400);
c4.Divide(1,1,0,0);
c4.cd();

gr1->Draw();
gr1->GetXaxis()->SetTitle("Sample Number");
gr1->GetYaxis()->SetTitle("ADC value");
gr1->SetTitle("Event 2, Bank 0, Channel 0");
gr1->SetMarkerColor(4);
gr1->Draw("ALP");

sprintf(plotName,"evt2Wave.png");
c4->Print(plotName);
